...
fn rich_render_blocks_prompt() -> String {
    "Rich render block module: use optional typed fenced blocks only when structure improves readability. Supported: ```matrix with JSON {\"rows\":[[...]],\"rowLabels\":[],\"columnLabels\":[],\"activeRow\":0,\"activeColumn\":1,\"highlightCells\":[[0,1]]}; ```vector with {\"values\":[...],\"labels\":[],\"orientation\":\"row|column\",\"activeIndex\":0}; ```chart with {\"type\":\"line|bar\",\"xLabel\":\"...\",\"yLabel\":\"...\",\"series\":[{\"label\":\"...\",\"points\":[[\"x\",1.2],[\"x2\",0.8]]}],\"activeIndex\":1}; ```step_example with {\"steps\":[{\"label\":\"1\",\"expression\":\"...\",\"explanation\":\"...\",\"result\":\"...\"}],\"activeStep\":0}; ```table with {\"columns\":[],\"rows\":[[...]]}; ```proof with {\"steps\":[{\"claim\":\"...\",\"reason\":\"...\",\"expression\":\"...\"}]}; ```source_list with {\"sources\":[{\"title\":\"...\",\"target\":\"...\",\"quote\":\"...\",\"score\":0.9}]}. Keep block JSON small and do not duplicate the same content in prose.".to_string()
}
