...
export function SearchPanel({ onClose: _onClose, onOpenTarget, windowed = false }: SearchPanelProps) {
    ...
    <aside
      className={
        windowed
          ...
          : "no-drag fixed left-3 right-3 top-12 z-50 max-h-[calc(100vh-64px)] max-w-[calc(100vw-24px)] overflow-hidden rounded-2xl border border-[color:var(--border)] bg-[color:var(--panel)] shadow-[0_12px_40px_rgba(0,0,0,0.14)] lg:left-auto lg:right-3 lg:w-[900px]"
      }
    >
      <div
      ...
      >
        <div className="mx-auto grid w-full max-w-[1040px] gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
