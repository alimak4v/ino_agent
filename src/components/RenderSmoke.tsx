...
const SMOKE_MARKDOWN = [
  ...
  "",
  String.raw`Malformed math recovery: Определение: Для тензоров $T \in T^{(r,s}(V)\) и \S \in T^{(p,q$}(V)), их тензорное произведение — это тензор`,
  "",
  String.raw`T \otimes $S \in T^{(r+p,s+q)}(V)$`,
  "",
  `${FENCE}cpp`,
  '#include <iostream>',
  "",
